                            ...
                            @if ($category->has_size==1)
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_xs" name="price_xs" value="{{$product->price_xs}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_s" name="price_s" value="{{$product->price_s}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_m" name="price_m"  value="{{$product->price_m}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_l" name="price_l"  value="{{$product->price_l}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_xl" name="price_xl"  value="{{$product->price_xl}}">
                                    </div>
                                </div>
