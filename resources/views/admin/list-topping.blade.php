            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-12 co-md-3 col-lg-3">
                        <button class="w-100 btn btn-primary" onclick="location.href='{{ route('createTopping') }}'">Nuevo Topping</button>
                    </div><br>
                            ...
                            <tbody id="bodytable">
                                @foreach ($list_topping as $item)
                                    <tr>
                                        ...
                                        <td><center>
                                            <a title="Editar" href="{{ route('editTopping', $item->name) }}"><i class="icono-feather" data-feather="edit"></i></a>
                                        </center></td>
                                    </tr>
                                @endforeach
                            </tbody>
