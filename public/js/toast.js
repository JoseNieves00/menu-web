...
Toast.prototype._createElements = function () {
    ...
    return new Promise(function (resolve, reject) {
        ...
        _this.toastContainerEl.style = "cursor:pointer";
...
Toast.prototype._addEventListeners = function () {
    ...
    document.querySelector('.toastjs-container').addEventListener('click', function () {
        _this2._close();
    });
...
Toast.prototype._open = function () {
    ...
    this.toastEl.innerHTML = '<p>' + this.options.message + '</p>' + customButtons + '';

    this.focusedElBeforeOpen = document.activeElement;
    document.querySelector('.toastjs-container').focus();
};
